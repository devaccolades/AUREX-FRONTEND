...
export default function SuccessModal({ isOpen, projectName, onClose }) {
            ...
            >
                ...
                <div className="mt-6 max-w-xl hidden md:block">
                    <p className="text-[14px] sm:text-[15px] leading-relaxed text-white">
                        ...
                        <br />
                        Our team will review your enquiry and get back to you shortly with the
                        details you requested.
                        <br />
                        We appreciate your time and look forward to assisting you in making an
                        informed decision.
                    </p>
                </div>
