  ...
  "
      >
        ...
        <p className="text-[15px] sm:text-[16px] leading-snug text-[#0F493D]">
          <span className="block">Your application has been</span>
        ...
        <div className="mt-6 max-w-xl hidden md:block">
          <p className="text-[14px] sm:text-[15px] leading-relaxed text-white">
            Our team will review your enquiry and get back to you shortly with
            the details you requested.We appreciate your time and look forward
            to assisting you in making an informed decision.{" "}
          </p>
        </div>

        {/* Stay Connected */}
        <div className="mt-10">
          <div className="flex flex-col gap-1 md:gap-4 sm:flex-row sm:items-center sm:justify-between">
