            ...
            >
                ...
                <div className="mt-6 max-w-xl hidden md:block">
                    <p className="text-[14px] sm:text-[15px] leading-relaxed text-white">
                        We appreciate your interest in joining our team.Our HR department will review your profile and get in touch if your qualifications match our requirements.
                    </p>
                </div>
                ...
                <div className="mt-10">
                    <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <p className="flex-1 text-[13px] leading-relaxed text-white/90 text-start">
                            follow us for career updates, project insights, and company news.
                        </p>
                    </div>
                </div>
