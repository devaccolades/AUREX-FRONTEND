...
export default function ProjectHero({ project }) {
  ...
  return (
    <main>
      <section className="relative w-full h-[80vh] md:h-[580px] lg:h-[780px] xl:h-[100vh] mb-10 overflow-hidden">
        {image && (
          <Image
            src={image}
            alt={image_alt || name}
        ...
        <div className=" absolute md:-bottom-8 left-[5%] lg:left-[10%] pb-10 z-20 lg:w-[80%] w-[90%] mx-auto hidden md:grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-5 ">
    ...
    `,
      ...
      <div className="relative z-20 lg:w-[80%] w-[90%] mx-auto mt-5 grid grid-cols-1 md:grid-cols-3 gap-5 ">
