...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden py-20">
      <div className="absolute w-full h-full inset-0 flex opacity-50">
      ...
      {/* CONTENT */}
      <div className="relative z-10 max-w-7xl mx-auto px-0 md:px-4 lg:px-10 items-center justify-center pt-[50px]">
        {/* TOP HEADING */}
        <div
          ...
          <div
            className={`relative justify-self-center md:justify-self-end shadow-2xl z-20 transition-all duration-1500 ease-in-out  ${
              animated
                ...
                : "w-screen h-[50vh] md:w-[50vw] md:h-screen fixed top-0 left-0  md:mt-[-290px]  lg:mt-[-320px]"
            }`}
          >
            <Image
              ...
              <div
                className={`relative shadow-2xl z-20 transition-all duration-1500 ease-in-out ${
                  animated
                    ...
                    : "h-[50vh] w-[100vh] md:w-[50vw] md:h-screen fixed top-0 right-0 md:mt-[-460px] lg:mt-[-520px] xl:mt-[-630px]"
                }`}
              >
                <Image
        ...
        <div className="md:hidden flex flex-col items-center gap-0 px-[16px]">
          <div className={`flex ${animated ? " w-[98%]" : "w-screen"}`}>
            {/* Top building image */}
              <div
              className={`relative shadow-2xl transition-all duration-1500 ease-in-out  ${
                animated
                  ? "w-full h-[118px] flex-1 "
                  : "w-[100vw] h-[50vh] mt-[-230px] top-[20%] left-1/2 -translate-x-1/2"
              }`}
            >
              <Image
                src="/images/about/v1.webp"
            ...
            <h3
              className={`font-urban text-[24px] font-bold leading-[26px] text-left transition-opacity duration-1000 delay-700 flex-1 ml-[8px] ${
                animated ? "opacity-100 " : "opacity-0 hidden"
              }`}
            >
              BUILDING <br />
              TRUST WITH <br />
